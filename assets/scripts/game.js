...
window.addEventListener('keydown', (e) => {
    if (e.keyCode == 39) {      // When the RIGHT arrow key is pressed (keyCode 39), set the RIGHT property to true
        keyboard.RIGHT = true;
    }   
    if (e.keyCode == 37) {      // When the LEFT arrow key is pressed (keyCode 37), set the LEFT property to true
        keyboard.LEFT = true;
    }
    if (e.keyCode == 38) {      // When the UP arrow key is pressed (keyCode 38), set the UP property to true
        keyboard.UP = true;
    }
    if (e.keyCode == 40) {      // When the DOWN arrow key is pressed (keyCode 40), set the DOWN property to true
        keyboard.DOWN = true;
    }
...
window.addEventListener('keyup', (e) => {
    if (e.keyCode == 39) {      // When the RIGHT arrow key is released (keyCode 39), set the RIGHT property to false
        keyboard.RIGHT = false;
    }
    if (e.keyCode == 37) {      // When the LEFT arrow key is released (keyCode 37), set the LEFT property to false
        keyboard.LEFT = false;
    }
    if (e.keyCode == 38) {      // When the UP arrow key is released (keyCode 38), set the UP property to false
        keyboard.UP = false;
    }
    if (e.keyCode == 40) {      // When the DOWN arrow key is released (keyCode 40), set the DOWN property to false
        keyboard.DOWN = false;
    }
